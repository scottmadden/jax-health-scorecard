...
.filters{background:white;border:1px solid #e0e0e0;border-radius:6px;padding:20px;margin-bottom:24px}
.filter-row{display:flex;gap:16px;align-items:center;margin-bottom:12px}
.filter-row:last-child{margin-bottom:0}
.filter-label{font-size:0.85rem;color:#666;min-width:80px;font-weight:500}
.filter-group{display:flex;gap:8px;flex-wrap:wrap;flex:1}
.filter-btn{padding:8px 16px;border:1px solid #ddd;border-radius:6px;background:white;cursor:pointer;font-size:0.85rem;transition:all 0.2s}
